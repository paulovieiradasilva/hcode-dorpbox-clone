class DropboxController {
    ...
    connectFirebase() {
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyB0L2tC50IVE7ImvjmE5Nqvm3tpdx6gaxM",
            authDomain: "dropbox-clone-f9bb3.firebaseapp.com",
            databaseURL: "https://dropbox-clone-f9bb3.firebaseio.com",
            projectId: "dropbox-clone-f9bb3",
            storageBucket: "dropbox-clone-f9bb3.appspot.com",
            messagingSenderId: "604297508769",
            appId: "1:604297508769:web:b0a9176f15beb2449f3de0",
            measurementId: "G-SLK5S1J9VC"
        };
        // Initialize Firebase
    ...
    formatTimeToHuman(duration) {
        ...
        if (hours > 0) {
            return `${hours} horas, ${minutes} minutos, ${seconds} e segundos`;
        }

        if (minutes > 0) {
            return `${minutes} minutos, ${seconds} e segundos`;
        }
    ...
    readFiles() {
        ...
        this.getFirebaseRef().on('value', snapsht => {

            this.listFilesEl.innerHTML = '';

            snapsht.forEach(item => {
    ...
    renderNav() {
        ...
        for (let i = 0; i < this.currentFolder.length; i++) {
            ...
            if ((i + 1) === this.currentFolder.length) {
                ...
                span.innerHTML = folderName.toLocaleLowerCase();
                ...
                span.innerHTML = `
                    <span class="ue-effect-container uee-BreadCrumbSegment-link-0">
                        <a href="#" data-path=${path.join('/')} class="breadcrumb-segment">${folderName.toLocaleLowerCase()}</a>
                    </span>
        ...
        li.addEventListener('click', event => {
            ...
            if (!event.ctrlKey) {
                ...
                this.listFilesEl.querySelectorAll('li.selected').forEach(el => {
                    /*
                        Faço uma verificação aqui, pois se remover a seleção do item atual
                        quando executar o toggle logo em seguida ele irá marca-lo novamente
                        nunca conseguindo desmarcar o item.
                    */
